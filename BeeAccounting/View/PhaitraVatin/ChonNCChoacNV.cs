...
{
    public partial class ChonNCChoacNV : Form
    {
        public Boolean chon { get; set; }

       

        public Boolean chonNCC { get; set; }
       // public Boolean chonNV { get; set; }
        ...
        {
            cb_nhanvientamung.Checked = !cb_nhacungung.Checked;

        }

        private void cb_nhanvientamung_CheckedChanged(object sender, EventArgs e)
        {
            cb_nhacungung.Checked = !cb_nhanvientamung.Checked;
        }
    }
}
