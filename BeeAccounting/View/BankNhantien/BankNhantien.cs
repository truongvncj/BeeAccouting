...
namespace BEEACCOUNT.View
{
    ...
    public partial class BankNhantien : Form
    {
        ...
        public BankNhantien(View.Main Main)
        {
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Dinhkhoannhantien Dinhkhoannhantien = new Dinhkhoannhantien(taikhoanbank.Noidung, taikhoanbank.NHpsCo.ToString());



            Dinhkhoannhantien.ShowDialog();

            bool kq = Dinhkhoannhantien.chon;
            ...
            if (kq) // newu tru tức là có chọn ta mở mục tài khoản định khoản tổng hợp chi tiết cho doanh thu
            {
             ...
             //    int chitietid = thanhtoanbank.;
              ...
              butoanbank.Diengiai = Dinhkhoannhantien.noidung;// "Doanh thu hóa đơn " + nguoimua.kyhieuhoadon + " " + nguoimua.sohoadon;
                ...
                butoanbank.PsCo = taikhoanbank.NHpsCo;// nguoimua.tientruocvat;
                butoanbank.PsNo = taikhoanbank.NHpsCo;// nguoimua.tientruocvat;
                butoanbank.TkCo = Dinhkhoannhantien.mataikhoan;
                butoanbank.MaCTietTKCo = Dinhkhoannhantien.machitiettaikhoan;
                butoanbank.tenchitietCo = Dinhkhoannhantien.tentaikhoanchitiet;

                butoanbank.TkNo = "1121";
                ...
                Buttoannhantien Buttoannhantien = new Buttoannhantien(detailbt, idtk);

                Buttoannhantien.ShowDialog();
