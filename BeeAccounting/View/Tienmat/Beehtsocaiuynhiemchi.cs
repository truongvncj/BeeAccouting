...
{
    public partial class Beehtsocaiuynhiemchi : Form
    {
        View.Beeuynhiemchi uynhiemchi;
        ...
        public Beehtsocaiuynhiemchi(View.Beeuynhiemchi uynhiemchi, string labe1, string labe2, string labe3)
        {
            ...
            txtTongno.Text = uynhiemchi.pssotienno.ToString("#,#", CultureInfo.InvariantCulture);
            txtTongco.Text = uynhiemchi.pssotienco.ToString("#,#", CultureInfo.InvariantCulture);


            this.pssotienco = uynhiemchi.pssotienco;
            this.pssotienno = uynhiemchi.pssotienno;
        ...
        private void bt_themvao_Click(object sender, EventArgs e)
        {
            ...
            this.uynhiemchi.add_detailGridviewTkNoUNC(socaitemp);
            ...
            txtChenlech.Text = (-uynhiemchi.pssotienno + uynhiemchi.pssotienco).ToString("#,#", CultureInfo.InvariantCulture);
