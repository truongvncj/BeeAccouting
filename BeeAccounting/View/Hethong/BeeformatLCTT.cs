...
{
    public partial class BeeformatLCTT : Form
    {
        ...
        public void reloadgridview()
        {
            ...
            dataGridViewformatBCTC.DataSource = Model.formatBCTC.LisDanhSachLCTTformat();
     ...
     public void reloadtxtchuoitinh(string chuoitinhmoi)
        ...
        void Control_KeyPress(object sender, KeyEventArgs e)
        {
            ...
            if (e.Control == true && e.KeyCode == Keys.N )
            {
                                    ...
                                    if (!kq)
                                    {
                                        View.ThemtktinhLCTT ThemtktinhLCTT = new ThemtktinhLCTT(this);
                                        ThemtktinhLCTT.Show();
                                    }
        ...
        public BeeformatLCTT(View.Main Main)
        {
            InitializeComponent();
      ...
      //      string SelectedItem = view.Rows[i].Cells["Tk_Có"].Value.ToString();
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var formatcachtinh = (from c in db.LCTTTT200formats
                ...
                {
                    LCTTTT200format chitieu = new LCTTTT200format();
                    chitieu.cachtinh = txtchuoicachtinh.Text.Trim();
                    chitieu.machitieu = txtmachitieu.Text.Trim();
                    db.LCTTTT200formats.InsertOnSubmit(chitieu);
                    db.SubmitChanges();
                }
        ...
        private void txtmachitieu_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
            {
                ...
                var cacttinh = (from c in db.LCTTTT200formats
                              where c.machitieu.Trim() == txtmachitieu.Text.Trim()
        ...
        private void dataGridViewformatBCTC_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridViewformatBCTC.RowCount > 0)
            {
                ...
                if (this.dataGridViewformatBCTC.CurrentCell.RowIndex >= 0)
                {
                    ...
                    var chitieuchon = (from p in dc.LCTTTT200formats
