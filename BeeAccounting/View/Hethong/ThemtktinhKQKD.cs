...
namespace BEEACCOUNT.View
{
    ...
    public partial class ThemtktinhKQKD : Form
    {
        // View.BeeformatCDKT BeeformatCDKT;

        View.BeeformatKQKD formatkqkd;
        ...
        public ThemtktinhKQKD(View.BeeformatKQKD formatkqkd)
        {
        ...
        private void bt_themvao_Click(object sender, EventArgs e)
        {
         ...
         //   txtchuoicachtinh.
            ...
            this.formatkqkd.reloadgridview();

            this.formatkqkd.reloadtxtchuoitinh(txtchuoi.Text);
