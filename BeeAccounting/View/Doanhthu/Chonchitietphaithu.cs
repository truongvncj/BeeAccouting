...
namespace BEEACCOUNT.View
{
    ...
    public partial class Chonchitietphaithu : Form
    {
        ...
        public Chonchitietphaithu(string headcolumname, IQueryable rs, LinqtoSQLDataContext dc)
        {
            InitializeComponent();
        ...
        private void tbsochitiet_Click(object sender, EventArgs e)
        {
            ...
            Beemosochitiettaikhoan mochitiet = new Beemosochitiettaikhoan(5, "131", 0);
