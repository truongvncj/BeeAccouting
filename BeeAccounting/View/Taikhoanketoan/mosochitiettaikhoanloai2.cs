...
namespace BEEACCOUNT.View
{
    ...
    public partial class mosochitiettaikhoanloai2 : Form
    {
        ...
        public static IQueryable viewgridloca(string taikhoan)
        {
            ...
            var rs = from dschitiet in dc.tbl_machitiettks
                     where dschitiet.matk.Contains( taikhoan)
                     select new
                     {
        ...
        public mosochitiettaikhoanloai2(int manghiepvu, string matk, int id) // manghiepvu = 1 xóa; int = 2 sửa ; int = 3 tao mới; int = 4 vừa sửa+ xóa; 5 ; vua sưa, xoa , tạo moi chỉ mỗi loại tk đó
        {
            InitializeComponent();
            this.matk = matk;
            this.id = id;
