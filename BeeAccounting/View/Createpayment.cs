...
namespace BEEACCOUNT.View
{
    ...
    public partial class Createpayment : Form
    {
        ...
        //                 where tbl_kacontractsdetailpayment.ContractNo == contractno && tbl_kacontractsdetailpayment.PayControl == "REQ" && tbl_kacontractsdetailpayment.CRDUSR == Username && tbl_kacontractsdetailpayment.BatchNo == 0
        //                 select new
        //                 {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //    ///     requestmaster.AchievedVolPCs
            //    ///         requestmaster.AchievedVol
            //    //         requestmaster.Achievedpercent
