...
namespace BEEACCOUNT.View
{
    ...
    public partial class BeeLCTT200dauky : Form
    {
        ...
        public BeeLCTT200dauky(int namchon)
        {
            InitializeComponent();
            ...
            var kq = from p in dc.LTTT200Daukies
                     where p.nam == namchon
                     select new
                     {
            ...
            {
                var kq2 = from p in dc.LTTT200Daukies
                          where p.nam == 2006
                          select new
                          {
                              Chỉ_tiêu = p.Tenchitieu,
        ...
        private void btchangecontractitem_Click(object sender, EventArgs e)
        {
            ...
            if (kq.Count() > 0)
            {
                foreach (var c in dataGridView1.Rows)
                {
                    ...
                    var ma = (from p in dc.LTTT200Daukies
                              where p.id == id2
            ...
            else
            {
                ...
                foreach (var c in dataGridView1.Rows)
                {
                    ...
                    //          ID = p.id
                    DataGridViewRow ro = (DataGridViewRow)c;
                    LTTT200Dauky p = new LTTT200Dauky();
                    p.nam = this.namchon;
                ...
                //    p.Cachghi = (string)ro.Cells["Cách_ghi"].Value;
                    ...
                    dc.LTTT200Daukies.InsertOnSubmit(p);
                    dc.SubmitChanges();
                }
